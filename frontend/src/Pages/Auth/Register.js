...
import "./auth.css"; // Ensure this file is linked
...
const Register = () => {
  ...
  return (
    ...
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      />
      <Container className="mt-5 slide-in-container" style={{ position: 'relative', zIndex: 2, color: 'black', backgroundColor: 'white', width: '50vw', height: '90vh', borderRadius: '30px' }}>
        <Row>
          <h1 className="text-center">
            <AccountBalanceWalletIcon sx={{ fontSize: 40, color: "black" }} className="text-center" />
          </h1>
          <h1 className="text-center text-black">Welcome to Explore And Track Your Expenses</h1>
